...
import React from "react";nst FotoPerfilClientSide = ({
  ...
  return (
    // // esnt-disable-next-line @next/next/no-img-element
    <img
      ...
      onError={(e) => {
        // // Cambiar la iman a la imagen por defecto cuando ocurre un error de carga
        const imgElement = e.currentTarget as HTMLImageElement;
        imgElement.src = "/images/svg/No-Foto-Perfil.svg";
        // // Opcnal: eliminar el evento onError para prevenir bucles infinitos
