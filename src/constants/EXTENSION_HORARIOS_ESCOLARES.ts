...
/**
* Exnsión de tiempo antes del horario oficial de entrada de estudiantes de primaria @example Si el horario oficial es 7:45 AM y la extensión es 60 minutos, los estudiantes podrán registrar asistencia desde las 6:45 AM
*/
export const EXTENSION_ENTRADA_ESTUDIANTES_PRIMARIA = 60; // /nutos
...
*/
export const EXTENSION_SALIDA_ESTUDIANTES_PRIMARIA = 60; // /nutos

// // ===== NIVEL SECUNDARIA =====

/**
* Exnsión de tiempo antes del horario oficial de entrada de estudiantes de secundaria @example Si el horario oficial es 1:00 PM y la extensión es 60 minutos, los auxiliares podrán tomar asistencia desde las 12:00 PM
*/
export const EXTENSION_ENTRADA_ESTUDIANTES_SECUNDARIA = 60; // /nutos
...
*/
export const EXTENSION_SALIDA_ESTUDIANTES_SECUNDARIA = 60; // /nutos

// // ===== UTILIDADES =====

/**
* nvierte minutos a milisegundos @param minutos Cantidad de minutos a convertir @returns Milisegundos equivalentes
*/
