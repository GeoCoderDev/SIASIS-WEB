export class Speaker {
  ...
  // //nstructor privado para evitar instanciación directa
  private constructor() {
  ...
  // // Método para obner la instancia única
...
*/
  public start(
    ...
    // // Alnalizar la síntesis, se cambia speaking a false y se ejecuta el callback
    utterance.onend = () => {
